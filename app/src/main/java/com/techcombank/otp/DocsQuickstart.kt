...
object DocsQuickstart {
    /** Application name.  */
    const val APPLICATION_NAME = "Google Docs API Java Quickstart"
    ...
    private const val TOKENS_DIRECTORY_PATH = "tokens"
     const val DOCUMENT_ID = "195j9eDD3ccgjQRttHhJPymLJUCOUjs-jmwTrekvdjFE"

    /**
     * Global instance of the scopes required by this quickstart.
     * If modifying these scopes, delete your previously saved tokens/ folder.
     */
    private val SCOPES = listOf(DocsScopes.DOCUMENTS_READONLY)
    ...
    @Throws(IOException::class)
     fun getCredentials(HTTP_TRANSPORT: NetHttpTransport): Credential {
        ...
        val `in` =
            DocsQuickstart::class.java.getResourceAsStream(CREDENTIALS_FILE_PATH)
...
//            .setDataStoreFactory(FileDataStoreFactory(File(TOKENS_DIRECTORY_PATH)))
    ...
    fun main(args: Array<String>) {
        ...
        val response = service.documents()[DOCUMENT_ID].execute()
